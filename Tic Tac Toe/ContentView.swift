...
struct ContentView: View {
        ...
        VStack {
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.fixed(120), spacing: 15), count: 3), spacing: 15) {
                ForEach (0..<9) { index in
                    ...
                    .cornerRadius(100)//ciruclarness of each object
                    .onTapGesture{
    ...
    private func checkForWinner() {
        ...
        checkLine(a: 0, b: 3, c: 6) // left col
        checkLine(a: 0, b: 4, c: 8) // right to left diagonal
        checkLine(a: 2, b: 4, c: 6) // left to right diagonal
        checkLine(a: 1, b: 4, c: 7) // middle col
        checkLine(a: 2, b: 5, c: 8) // right col
